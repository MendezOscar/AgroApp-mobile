  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CropDetailCubit, CropDetailState>(
      builder: (context, state) {
        ...
        return PaginatedList<IrrigationEntity>(
          items: state.irrigations,
          hasNextPage: state.irrigationHasNextPage,
          isLoadingMore: state.isLoadingMoreIrrigation,
          onLoadMore: () =>
              context.read<CropDetailCubit>().loadMoreIrrigations(cropId),
          onRefresh: () =>
              context.read<CropDetailCubit>().loadIrrigations(cropId),
          emptyWidget: const Center(child: Text('No hay registros de riego')),
          itemBuilder: (_, item, __) => Card(
            ...
            child: ListTile(
              ...
              subtitle: Column(
                ...
                children: [
                  Text(DateFormat('dd/MM/yyyy HH:mm').format(item.appliedAt)),
